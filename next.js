...
console.log(color(figlet.textSync(`Alfa-Bot`, {
font: 'Standard',
...
kayla.sendMessage(num, { image: { url: ppuser }, contextInfo: { mentionedJid: [num] }, caption: `napa keluar anjeng` },
{quoted:{
key: {
fromMe: false, 
participant: `0@s.whatsapp.net`, ...(num ? { remoteJid: "@s.whatsapp.net" } : {}) 
},
"message": {
"documentMessage": {
...
if (reason === DisconnectReason.badSession) { console.log(`Bad Session File, Please Delete Session and Scan Again`); kayla.logout(); }
        ...
        kayla.sendText("6281327496283@s.whatsapp.net", `Halo Creator Ijin Pake Sc Bot Cilent-MD V1. Makasihh`)
        }
